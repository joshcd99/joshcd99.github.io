# Josh Dunlap · CISC 480 Portfolio

**CISC 480: Senior Capstone · Spring 2026 · University of St. Thomas**

This repository hosts my individual portfolio for the CISC 480 capstone. The live site is at **[joshcd99.github.io](https://joshcd99.github.io/)**.

Portfolio sections, all reachable from the landing terminal. Type the command, or click below:

- **[about](https://joshcd99.github.io/about/)**: who I am, and a unique-combination answer to *"why should we hire you?"*
- **[skills](https://joshcd99.github.io/skills/)**: technical and professional competencies
- **[projects](https://joshcd99.github.io/projects/)**: five entries (2 CS · 2 interdisciplinary · 1 strictly outside CS), with two SOAR-structured narratives and one failure → learning → change story
- **[resume](https://joshcd99.github.io/resume/)**: 1-page CV (PDF + text)
